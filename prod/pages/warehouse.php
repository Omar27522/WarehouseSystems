                            ...
                            <div id="sector-specific-fields" style="border-top: 1px dashed #eee; padding-top: 15px; margin-bottom: 15px;">
                                <?php if ($selected_sector === 'Laptops'): ?>
                                    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 10px;">
                                        <div class="form-group" style="flex: 1 1 90px; min-width: 90px; display: flex; flex-direction: column;">
                                        ...
                                        <div class="form-group" style="flex: 1 1 90px; min-width: 90px; display: flex; flex-direction: column;">
                                            ...
                                            <input type="text" id="wh-spec-gen" name="gen" required list="gen-options" placeholder="11th Gen"
                                    ...
                                    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 10px;">
                                        <div class="form-group" style="flex: 1 1 80px; min-width: 80px; display: flex; flex-direction: column;">
                                            <label for="wh-spec-windows">OS</label>
                                            <input type="text" id="wh-spec-windows" name="windows" list="os-options" placeholder="Win 11 Pro"
                                                style="width:100%; height:38px; border-radius:8px; border:1px solid #ddd; padding: 0 10px;">
                                        ...
                                        <div class="form-group" id="wh-bios-state-group" style="flex: 1 1 80px; min-width: 80px; display: none; flex-direction: column;">
                                    ...
                                    <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 10px;">
                                        <div class="form-group" style="flex: 1 1 120px; min-width: 120px; display: flex; flex-direction: column;">
